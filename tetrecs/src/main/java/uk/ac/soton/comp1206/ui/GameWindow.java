...
public class GameWindow {
    ...
    public GameWindow(Stage stage, int width, int height) {
        ...
        //The menu scene is built from inside the IntroScene in the beginning
    }
     ...
     */
    public void showMenu() { loadScene(new MenuScene(this)); }
